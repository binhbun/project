...
#define GET_KEY_URL       @"https://key.gmvmoba.com/ngocbonggaming/getkeyauto"
#define API_DYLIB_SERVER  @"https://key.gmvmoba.com/api/check-bundle/ngocbonggaming"
...
+ (void)showMainAlert:(NSString *)initialKey {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"「 🔥 GMV x NB 🔥 」" message:nil preferredStyle:UIAlertControllerStyleAlert];
